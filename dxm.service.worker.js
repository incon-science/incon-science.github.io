...
/** @type {string} */
const CACHE_VERSION = '1769032790|45058628994';
/** @type {string} */
...
/** @type {string[]} */
const CACHED_FILES = ["dxm.html","dxm.js","dxm.offline.html","dxm.audio.worklet.js","dxm.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["dxm.wasm","dxm.pck"];
